...
try:
    from fluves.saga_watem import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "fluves.saga_watem-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "fluves.saga_watem Documentation", "Fluves", "manual")
]
